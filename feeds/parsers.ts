...
function joinValuesOrEmptyString(values: Values): string {
...
export function parseRss(feedTitle: string, xml: any): Site | null {
...
export function parseAtom(feedTitle: string, xml: any): Site | null {
